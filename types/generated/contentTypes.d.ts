...
export interface ApiCharacterCharacter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    alive: Attribute.Boolean;
    role: Attribute.String;
    description: Attribute.String;
    creator: Attribute.String;
    first_appearance: Attribute.String;
...
export interface ApiConceptConcept extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    description: Attribute.String;
    related_characters: Attribute.JSON;
    related_locations: Attribute.JSON;
    first_appearance: Attribute.String;
    creator: Attribute.String;
    image_url: Attribute.String;
...
export interface ApiStorylineStoryline extends Schema.CollectionType {
